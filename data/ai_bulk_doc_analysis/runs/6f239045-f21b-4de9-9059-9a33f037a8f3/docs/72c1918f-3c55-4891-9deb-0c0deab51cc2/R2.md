...
- For the "just-in-time access" obligation, there is some ambiguity around the implementation details and criteria for feasibility. A medium severity gap was identified, along with two clarifying questions to ask the policy owner.
