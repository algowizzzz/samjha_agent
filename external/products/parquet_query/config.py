...
class QueryAgentConfig:
    ...
    def __init__(self, config_path: Optional[str] = None):
        if hasattr(self, "_initialized"):
            # If already initialized but new path provided, reload if different
        ...
        self.config_path = config_path or os.path.join("external", "config", "agent", "queryagent_planner.json")
