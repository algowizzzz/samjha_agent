...
<small>¹ The capital and leverage requirements for domestic systemically important banks are supplemented by the requirements described in OSFI's **Total Loss Absorbing Capacity (TLAC)** Guideline.</small>
...
<sup>5</sup> SMSB Capital and Liquidity Guideline

---

Here is the transcription of the document page:

**Overview of risk-based capital requirements**

6. The criteria for the capital elements comprising the two tiers, as well as the various limits, restrictions and regulatory adjustments to which they are subject, are described in Chapter 2.
