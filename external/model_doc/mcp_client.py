...
class ModelDocMCPClient:
    """Lightweight wrapper for executing model-doc MCP tools."""
...
_default_client: Optional[ModelDocMCPClient] = None


def get_mcp_client() -> ModelDocMCPClient:
    global _default_client
    if _default_client is None:
        _default_client = ModelDocMCPClient()
